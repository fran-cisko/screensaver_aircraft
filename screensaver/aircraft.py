...
class Aircraft(FlyingObject):
    # position es la posición inicial y direction es la diricción inicial
    ...
    def move(self, direction: Direction = None) -> None:
        ...
        match direction:
            case direction.NorthEast: # cómo son los rebotes
            ...
            case direction.NorthWest:
                # TODO falta desarrollar los distintos casos
...
# Método de creación del objeto aircraft.
